...
Recomendaciones
Podés usar Ollama y su API REST para obtener las respuestas del entrevistAIdor. El modelo llama3 funciona bastante bien.
Podés usar Web Speech API para convertir audio a texto y texto a audio.
